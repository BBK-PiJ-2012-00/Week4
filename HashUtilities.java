...
// ShortHash determined by remainder after division by 1000 - give a random enough number, based on remainders, preventing hash collision if numbers starting with 1 (10-19) were only entries - provides uniqueness.
...
println "Give me a string and I will calculate its hash code"; String str = System.console().readLine(); int hash = str.hashCode(); int smallHash = HashUtilities.shortHash(hash); System.out.println("0 < " + smallHash + " < 1000");
*/
